  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isInstallment && paymentMethod === 'credit') {
        ...
        // GERA ID DE GRUPO PARA AS PARCELAS
