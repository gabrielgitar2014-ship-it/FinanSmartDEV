...
// Expande as linhas de uma fatura JÁ IMPORTADA (cada linha pode trazer
// "parcela atual/total" e o valor da parcela) em transações individuais.
// Diferente de billingService.generateInstallments, que gera o cronograma
// de parcelas de uma COMPRA NOVA a partir do valor total.
export const expandInvoiceInstallments = (transactions, referenceMonthStr, accountId) => {
