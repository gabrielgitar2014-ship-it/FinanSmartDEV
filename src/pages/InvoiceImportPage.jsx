...
// URL DO SEU BACKEND NO GOOGLE CLOUD RUN
...
export default function InvoiceImportPage() {
  ...
  if (view === 'review') {
    return (
      <div className="h-full flex flex-col bg-slate-50 font-sans animate-in slide-in-from-right-8 duration-500">
        <div className="px-6 py-5 border-b border-slate-200 sticky top-0 z-20 bg-white">
  ...
  return (
    <div className="h-full flex flex-col bg-slate-100 overflow-hidden font-sans relative">
      ...
      {/* BOTÕES FLUTUANTES */}
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 flex gap-2 p-1.5 bg-white/90 backdrop-blur-lg shadow-lg border border-slate-200 rounded-full transition-all scale-90 sm:scale-100">
        <button 
        ...
        <button 
          ...
          className={`px-5 py-2.5 rounded-full text-sm font-bold flex items-center gap-2 transition-all ${interactionMode === 'draw' ? 'bg-indigo-600 text-white shadow-md ring-2 ring-indigo-200' : 'text-slate-500 hover:bg-slate-100'}`}
        >
