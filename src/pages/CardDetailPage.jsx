    ...
    content = (
      <div className="pb-28 lg:pb-0">
        ...
        <div className="px-4 -mt-6 mb-4 relative z-10">
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 p-4">
            ...
            <button
              ...
              className="w-full mt-3 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold text-sm shadow-md shadow-indigo-500/20 flex items-center justify-center gap-2 transition-all active:scale-95"
            >
              Pagar fatura
            </button>
          </div>
        ...
        <PayInvoiceModal
          ...
          card={card}
          invoiceTotal={activeInvoice.total || 0}
          onSuccess={() => refetch()}
        />
      </div>
    );
